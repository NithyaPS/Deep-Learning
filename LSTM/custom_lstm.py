...
glove_folder='DLENV/LSTM/Glove/'
maxlen = 50
print("---------------------- Downloading Dataset -------------------------\n")

dataset =  pd.read_csv('DLENV\DNN\DL-Algorithms\SMSSpamCollection.txt',sep='\t',names=['label','message'])
print("----------------------  -------------------------\n")
...
def plot_confusion_matrix(y_true, y_pred):
   ...
   plt.savefig('DLENV/LSTM/results/results.jpg')
...
with open("lstm_smsspam.pkl",'wb') as model_file:
